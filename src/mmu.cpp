...
void MMU::load_default_boot_rom() { std::copy(noobboy_boot_rom, noobboy_boot_rom + sizeof(noobboy_boot_rom), memory); }

void MMU::save_game_state() { cartridge->write_save_state(); }
